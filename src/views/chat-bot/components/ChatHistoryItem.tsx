    ...
    return (
        <div
            className={classNames(
                'rounded-[5px] p-2 px-3 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer group relative',
        ...
        >
            <div>
                <div className="heading-text font-bold truncate">{conversation}</div>
